(function() {
  ...
  CJsl = (function() {
    ...
    CJsl.prototype.apply = function() {
      var des, i, key, key1, val, val1, _len;
      i = 0;
      for (key = 0, _len = arguments.length; key < _len; key++) {
        val = arguments[key];
        if (i === 0) {
          i = 1;
          des = val;
  ...
  Jsl.CElement = (function(_super) {
    ...
    CElement.prototype.draw = function() {
      var me;
      me = this;
      if (me.renderTo) return me.renderTo.appendChild(me.doc);
    };
    ...
    CElement.prototype.attr = function(obj) {
      ...
      me = this;
      doc = me.doc;
      if (typeof obj === "string") return doc.getAttributeNS(null, obj);
      for (key in obj) {
        val = obj[key];
